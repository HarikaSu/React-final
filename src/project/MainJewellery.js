...
//         </span>
//         <button
//           className="navbar-toggler ms-auto" // Positioning toggle button to the right
//           type="button"
...
//           <div className="d-flex ms-auto justify-content-between w-30 "style={{ gap: '20px' }}>
//             <button className="btn btn-outline-light mb-2" onClick={() => navigate("/cart", { state: { cart } })}>
